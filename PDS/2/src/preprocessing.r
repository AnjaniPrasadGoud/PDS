...
Student = read.csv("C:\\Users\\anjan\\OneDrive\\Documents\\PDS\\2\\data_raw\\StudentsPerformance.csv")
Student
...
#save the clean Data
write.csv(Student_Data,"C:\\Users\\anjan\\OneDrive\\Documents\\PDS\\2\\data_clean\\clean_StudentsData.csv")
